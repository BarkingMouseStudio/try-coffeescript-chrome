...
(function() {
var Builder, Code, Node, Transformer, Typenames, Types, UnsupportedError, blockTrim, buildCoffee, exports, isSingleLine, ltrim, p, paren, parser, rtrim, strEscape, strRepeat, trim, truthy, unreserve, unshift, _, _ref, _ref1,
__slice = [].slice,
...
_ref1 = this.Js2coffeeHelpers || require('./helpers'), Code = _ref1.Code, p = _ref1.p, strEscape = _ref1.strEscape, unreserve = _ref1.unreserve, unshift = _ref1.unshift, isSingleLine = _ref1.isSingleLine, trim = _ref1.trim, blockTrim = _ref1.blockTrim, ltrim = _ref1.ltrim, rtrim = _ref1.rtrim, strRepeat = _ref1.strRepeat, paren = _ref1.paren, truthy = _ref1.truthy;
...
var _ref2;
if (n.thenPart.children.length === 0 && ((_ref2 = n.elsePart) != null ? _ref2.children.length : void 0) > 0) {
n.positive = false;
